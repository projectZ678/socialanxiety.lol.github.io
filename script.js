...
document.addEventListener('DOMContentLoaded', () => {
  ...
  homeButton.addEventListener('click', () => {
    switchTheme('assets/anime_red.mp4', backgroundMusic, 'home-theme');
  });
  ...
  hackerButton.addEventListener('click', () => {
    switchTheme('assets/anime_red.mp4', hackerMusic, 'hacker-theme', hackerOverlay, false);
  });
  ...
  rainButton.addEventListener('click', () => {
    switchTheme('assets/anime_red.mp4', rainMusic, 'rain-theme', snowOverlay, true);
  });
  ...
  animeButton.addEventListener('click', () => {
    switchTheme('assets/anime_red.mp4', animeMusic, 'anime-theme');
  });
  ...
  carButton.addEventListener('click', () => {
    switchTheme('assets/anime_red.mp4', carMusic, 'car-theme');
  });
